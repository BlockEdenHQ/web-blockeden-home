...
export function StellarSorobanPage() {
  ...
  if (Math.random() >= 0.3) {
    ...
    heroLink = "https://blockeden.xyz/api-marketplace/stellar-soroban-indexer";
  }
        ...
        <div className="container">
          <div className="row align-items-center justify-content-around o-hidden">
            ...
            <div className="col-lg-5 col-md-6" data-aos="fade-left">
              ...
              <a href="https://blockeden.xyz/api-marketplace/stellar-soroban-indexer" className="lead hover-arrow">
                Explore now
              </a>
            </div>
          </div>
