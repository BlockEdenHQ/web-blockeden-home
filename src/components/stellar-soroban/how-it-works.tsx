    ...
    <div className="container pt-3 pb-0">
      <div className="row justify-content-center text-center mb-6">
        <div className="col-xl-8 col-lg-9">
          ...
          <p className="lead">
            Login to our dashboard, create an API key, and get started to build.
          ...
          <div className="tab-content">
            ...
            >
              <div className="popover-image">
                <img
                  src="https://tp-misc.b-cdn.net/blockeden/soroban-how-indexer-works.png"
                  alt="Image"
            ...
            >
              <div className="popover-image">
                <img
                  src="https://tp-misc.b-cdn.net/blockeden/demo-dashboard-create-a-key.png"
                  alt="Image"
                  className="rounded shadow-lg"
                />
              </div>
            ...
            >
              <div className="popover-image">
                <img
                  src="https://tp-misc.b-cdn.net/blockeden/demo-dash-api-key.png"
                  alt="Image"
                  className="rounded shadow-lg"
                />
              </div>
