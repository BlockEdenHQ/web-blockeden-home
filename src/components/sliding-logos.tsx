...
import styles from "./sliding-logos.module.css";

export const SlidingLogos = () => {
  // https://jsfiddle.net/sergdenisov/wb28eeh2/3/
  return (
    <section>
      <div className={styles.container}>
        <div className="photobanner">
          <img className="photobanner-first" src="https://tp-misc.b-cdn.net/blockeden/Google_2015_logo.svg.png"/>
