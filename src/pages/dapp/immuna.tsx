...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recxWGOz7yQEhh6hD","name":"Immuna","introduction":"Immuna platform helps crypto investors manage their risks of investing in crypto assets.","website":"https://immuna.xyz/","twitter":"https://twitter.com/immuna_xyz","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
