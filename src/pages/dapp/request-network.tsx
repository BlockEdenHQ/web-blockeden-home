...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"receAqgJOiSyjhVQj","name":"Request Network","introduction":"Request allows companies & people to pay and get paid in cryptocurrencies by relying on the most innovative payment request technology.","website":"https://request.network/","twitter":"https://twitter.com/RequestNetwork","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/RequestNetwork","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"receGQPE0CmvWXJgc","name":"Commercial Finance"}],"chains":[]};
