...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recNGhrHcJxvYSXZI","name":"Web3Analytic","introduction":"No-code user analytics to help Web3 product and marketing teams convert, engage, and retain more users.","website":"https://web3analytic.xyz/","twitter":"https://twitter.com/web3analytic","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rech8ZZffiG9zOQga","name":"a16z crypto startup school"}],"chains":[{"id":"rece94Ok0M65eqMog","name":"Ethereum"},{"id":"rec17leN1lW22bWvK","name":"Polygon"},{"id":"rec83sK9xZYe0grQM","name":"Optimism"},{"id":"recLUPl9cA6js34h3","name":"Arbitrum"}]};
