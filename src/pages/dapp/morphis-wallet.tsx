...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rec60SdBb81dajFAc","name":"Morphis Wallet","introduction":"Morphis wallet is a friendly wallet to get started with your web3 journey. Morphis allows you to manage all your web3 assets in one place, from tokens and NFTs to game assets and your gateway to thousands of dApps. Morphis will be your single access point to the unlimited potential of the web3 world.","website":"https://morphiswallet.com/","twitter":"https://twitter.com/morphis_network","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recjlK9nrNPVACbL0","name":"Wallet"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
