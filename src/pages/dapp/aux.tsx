...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rect6gU03mqKDuZC1","name":"AUX","introduction":"AUX Exchange - Our mission is to provide the best decentralized trading experience possible. Now available on Aptos.","website":"https://aux.exchange/","twitter":"https://twitter.com/AuxExchange","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/aux-exchange","whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
