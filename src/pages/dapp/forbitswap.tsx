...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recTGnaLPe5GsJlYY","name":"Forbitswap","introduction":"Forbitswap is an all-in-one DeFi platform that offers a comprehensive range of services. It provides an Automated Market Maker (AMM) for efficient and decentralized trading, as well as a Decentralized Prediction Market, allowing users to speculate on the outcomes of future events in a decentralized manner.","website":"https://forbitswap.com/","twitter":"https://twitter.com/forbitswap","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
