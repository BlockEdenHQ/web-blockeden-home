...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recxXFBXWYN91DcV5","name":"Tortuga","introduction":"Tortuga Finance is a unique platform where users can stake APT. In addition to staking, Tortuga issues tAPT (Tortuga Staked APT), enabling users to remain staked while actively participating in the Aptos DeFi ecosystem.","website":"https://tortuga.finance/","twitter":"https://twitter.com/TortugaFinance","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
