...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recOCsRirUsIj2mO8","name":"Quantstamp","introduction":"Quantstamp’s mission is to secure the decentralized internet, and has protected over $200B in digital asset risk from hackers.","website":"https://quantstamp.com/","twitter":"https://twitter.com/quantstamp","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/quantstamp","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
