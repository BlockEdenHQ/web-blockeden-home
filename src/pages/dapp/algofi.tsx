...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rectieyuEla5k7u4v","name":"Algofi","introduction":"At Algofi, we're building the new financial system. Our work will reduce barriers to entry and promote democracy in the financial system.","website":"https://algofi.org/","twitter":"https://twitter.com/algofiorg","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/Algofiorg","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"recWLjiMK106T8B9O","name":"Lending"},{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[]};
