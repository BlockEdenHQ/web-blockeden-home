...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recYaX5isTq4phWF6","name":"Blocto","introduction":"Blocto Wallet - Your Web3 tomorrow starts today. Make crypto transactions in your control, get full royalties for your creativity, and more.","website":"https://token.blocto.app/","twitter":"https://twitter.com/BloctoApp","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/portto","whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
