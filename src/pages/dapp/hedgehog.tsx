...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recjFhgPrW9ADJjAw","name":"Hedgehog","introduction":"Hedgehog is a crypto robo-adviser that manages your funds in broad baskets of digital assets covering up to 85% of crypto's market cap.","website":"https://hedgehog.app/","twitter":"https://twitter.com/HedgehogDotApp","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"rec57HyMeH62koASo","name":"Robo-adviser"}],"chains":[]};
