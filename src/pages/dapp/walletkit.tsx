...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recvX0HIHewda79HV","name":"WalletKit","introduction":"WalletKit is a developer platform that abstracts away the complexities of blockchain tech and provides simple HTTP APIs.","website":"https://usewalletkit.com/","twitter":"https://twitter.com/tusharsoni1205","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/usewalletkit","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
