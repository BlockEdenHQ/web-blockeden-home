...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rec977i265U7aLn5m","name":"ECSA","introduction":"ECSA offers a seamless solution for converting Brazilian Real to BRLe, a fully collateralized stablecoin.","website":"http://ecsa.finance/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"recHgqwT3el1SCc3v","name":"Stable Coin"}],"chains":[]};
