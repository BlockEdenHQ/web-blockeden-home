...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recG18OOsk7erwDOo","name":"SFOX","introduction":"sFOX is the full-service crypto prime dealer for institutional investors, providing the liquidity, security, and infrastructure needed to unlock the full potential of digital assets.","website":"https://sfox.com/","twitter":"https://twitter.com/sfox","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/sfoxhq","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
