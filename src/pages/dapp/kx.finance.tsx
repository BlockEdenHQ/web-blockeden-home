...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recCxYdDNR74Hlnrh","name":"Kx.Finance","introduction":"A DeFi/DEX aggregator built on Sui and enables the trading of bonds, leverage and NFTs.","website":"https://www.kx.finance/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recjij7AtXPBhoL3j","name":"Dex"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
