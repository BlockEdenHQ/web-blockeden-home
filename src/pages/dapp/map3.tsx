...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recYxeTi9cg5RSgX3","name":"Map3","introduction":"Map3 connects crypto services to Wallets, Exchanges & Bridges to enable cross-chain deposits.","website":"https://map3.xyz/","twitter":"https://twitter.com/map3hq","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/map3xyz","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
