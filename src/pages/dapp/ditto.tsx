...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recFubzlS5RCsOl00","name":"Ditto","introduction":"Ditto is a liquid staking solution constructed on the Aptos blockchain. It allows users to stake their Aptos tokens to earn yield and contribute to the decentralization of the network, all while maintaining liquidity. This means users can earn rewards from staking while still having the flexibility to use their tokens as needed.","website":"https://www.dittofinance.io/","twitter":"https://twitter.com/Ditto_Finance","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
