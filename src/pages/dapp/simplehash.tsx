...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recHefnqwwKJNSzZi","name":"SimpleHash","introduction":"SimpleHash allows developers to query all NFT data from a single platform.","website":"https://www.simplehash.com/","twitter":"https://twitter.com/SimpleHashInc","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
