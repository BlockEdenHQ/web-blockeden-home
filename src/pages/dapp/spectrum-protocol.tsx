...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recVno1uqqENhL8Zl","name":"Spectrum Protocol","introduction":"Spectrum Protocol is an Innovative, Decentralized Yield Optimizer platform that allows users to earn compound interest on their crypto assets farming.","website":"https://aptos.spec.finance/","twitter":"https://twitter.com/SpecProtocol","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/spectrumprotocol","whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
