...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"recA9e08qAY2FbBIt","name":"DID","description":"DID (Decentralized Identity) is a new approach to identity verification without centralized control."};
  const tag = title;
