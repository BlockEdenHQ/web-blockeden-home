...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"reczZ3KIAmMRFCTDp","name":"Yatima Inc.","introduction":"Yatima is a verifiable computing platform which uses formal proofs and zkSNARKs to make software safer.","website":"https://github.com/yatima-inc","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/yatima-inc","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"reclEQU2qkwkTdH3d","name":"Zero-knowledge"}],"chains":[]};
