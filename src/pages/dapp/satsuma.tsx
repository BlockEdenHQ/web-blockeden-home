...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rec1VYFaRtUbArQ63","name":"Satsuma","introduction":"atsuma is a developer tool for building applications on top of real-time blockchain data.","website":"https://www.satsuma.xyz/","twitter":"https://twitter.com/satsumaxyz","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
