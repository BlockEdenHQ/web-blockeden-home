...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recOhaMivwgLqW78L","name":"Lucky Kat","introduction":"An award-winning mobile game studio with games that have been downloaded more than 200 million times on App Store and its first sold-out NFT project “Panzerdogs” is a top 10 Solana game.","website":"https://careers.lucky-kat.com/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recurwxmBmR0NX6iU","name":"GameFi"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
