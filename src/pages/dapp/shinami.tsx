...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recX6D1adcT1rSXm8","name":"Shinami","introduction":"Aims to provide the driving force for the next wave of DApps and to facilitate the construction of Sui blockchain for developers without necessarily running and maintaining nodes.","website":"https://www.shinami.com/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recruNGUb5CjfScHw","name":"Infrastructure"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
