...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recmboxndETNEbZQj","name":"Decent","introduction":"Decent has a full suite of no- and low-code tools for creators and organizations to easily build customized and user-friendly projects on the blockchain. ","website":"https://www.decent.xyz/","twitter":"https://twitter.com/decentxyz","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/decentxyz","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
