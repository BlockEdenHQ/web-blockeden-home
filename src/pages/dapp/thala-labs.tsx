...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recCOXEuP14yNFx4O","name":"Thala Labs","introduction":"Thala Labs enables seamless borrowing of dollars and efficient liquidity provisioning. Users can provide liquidity, stake, or utilize recursive borrows with $MOD to generate sustainable yields. Thala's weighted multi-asset AMM is designed for versatility, unlocking capital efficient swaps and liquidity provisioning.","website":"https://www.thala.fi/","twitter":"https://twitter.com/ThalaLabs","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/ThalaLabs","whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
