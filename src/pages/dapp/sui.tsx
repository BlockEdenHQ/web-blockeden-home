...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"recsjTJv52vVYdOqg","name":"Sui","description":"Sui is a decentralized permission smart contract platform biased towards low-latency management of assets."};
  const tag = title;
