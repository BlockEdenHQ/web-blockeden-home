...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recjAHRfebkHrIJ3a","name":"Terrace","introduction":"Terrace is a regulatory-compliant, all-in-one institutional-grade trading UI / terminal and infrastructure layer","website":"https://www.terrace.fi/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
