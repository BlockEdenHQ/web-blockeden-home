...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"reciV4yt6pmXYcG2B","name":"Payourse","introduction":"tools and infrastructure that make it easier, faster and cheaper for anyone in to build user friendly crypto and web3 products.","website":"https://payourse.com/","twitter":"https://twitter.com/payourse","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
