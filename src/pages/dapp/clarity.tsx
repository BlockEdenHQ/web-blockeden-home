...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recQecU01nMmzE0Xs","name":"Clarity","introduction":"A collaborative team workspace with Sign-in with Ethereum and token-based permissions. Write docs, manage projects, and organize knowledge with bidirectional links.","website":"https://www.clarity.so/","twitter":"https://www.twitter.com/clarityteams","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
