...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recOACMtjC6ARBSMe","name":"KIKI world","introduction":"KIKI  is building the future of customer-owned beauty where anyone can co-create and co-own the products they love to use. [yes, we make physical beauty products as well as on-chain products!]","website":"https://kiki.world","twitter":"https://twitter.com/kikiworld_","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rech8ZZffiG9zOQga","name":"a16z crypto startup school"}],"chains":[]};
