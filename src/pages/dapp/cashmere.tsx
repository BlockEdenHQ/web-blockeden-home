...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rec5McMaHsRAVIkPG","name":"Cashmere","introduction":"Cashmere is a multisig solana wallet for enterprises to manage their digital assets.","website":"https://cashmere.finance/","twitter":"https://twitter.com/CashmereWallet","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[{"id":"recP9ufPguGCX9q6a","name":"Solana"}]};
