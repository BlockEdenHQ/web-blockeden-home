...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"recHgqwT3el1SCc3v","name":"Stable Coin","description":"Stable Coin is a type of cryptocurrency designed to have a stable value compared to traditional currencies."};
  const tag = title;
