...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"reckcbPjMecU5MCqP","name":"F1 Dog","introduction":"The first NFT dog racing game built on Sui and Aptos blockchains.","website":"https://f1.dog/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recurwxmBmR0NX6iU","name":"GameFi"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
