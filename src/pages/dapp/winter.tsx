...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recPNZiuDIEmTzWl7","name":"Winter","introduction":"Winter offers an embeddable checkout widget for businesses & NFT projects to sell NFTs through a credit card","website":"https://usewinter.com/","twitter":"https://twitter.com/winter_NFTs","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"recxaaAgGx0u9YlEA","name":"NFT Checkout"}],"chains":[]};
