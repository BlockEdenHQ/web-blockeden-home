...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recbtha0z6n32iHZo","name":"Aptin Labs","introduction":"Aptin is a decentralised non-custodial liquidity market protocol where users can participate as depositors or borrowers.","website":"https://aptin.io","twitter":"https://twitter.com/aptinlabs","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/AptinLabs","whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
