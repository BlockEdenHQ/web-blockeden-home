...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"reculZIaLHC0qiCdV","name":"Wormhole","introduction":"A cross-chain protocol backed by Solana. In October 2022, Solana released an Ethereum token cross-chain bridge.","website":"https://wormhole.com/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recHw8cINcIMu9B07","name":"Cross-chain Bridge"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
