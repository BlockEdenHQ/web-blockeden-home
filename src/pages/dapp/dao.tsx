...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"reccVhTgz8mENzv9N","name":"DAO","description":"DAO (Decentralized Autonomous Organization) is an organization governed by rules encoded as computer programs on a blockchain."};
  const tag = title;
