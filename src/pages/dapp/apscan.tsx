...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recurpXx9ncswSJa7","name":"Apscan","introduction":"Apscan is the Aptos Blockchain Explorer and allows you to explore and search the accounts, blocks, transactions, assets and other network activities within the Aptos Network (APT).","website":"https://apscan.io/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recDBsMXVvsaL4k93","name":"Explorer"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
