...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"recruNGUb5CjfScHw","name":"Infrastructure","description":"Blockchain infrastructure is the tech framework supporting a decentralized digital ledger system. It ensures secure, immutable transactions via nodes, cryptography, consensus mechanisms, and smart contracts."};
  const tag = title;
