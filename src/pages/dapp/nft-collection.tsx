...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"reccOPMXhhegGDuTP","name":"NFT Collection","description":"An NFT Collection is a group of Non-Fungible Tokens, often linked by a common theme or created by the same artist. Each token in the collection represents a unique digital item or artwork."};
  const tag = title;
