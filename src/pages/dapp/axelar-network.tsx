...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recu5kuhDT3iQZNvo","name":"Axelar Network","introduction":"A Web3 cross-chain application that aims to provide a smooth cross-chain experience for public chains and their ecosystems.","website":"https://axelar.network/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recHw8cINcIMu9B07","name":"Cross-chain Bridge"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
