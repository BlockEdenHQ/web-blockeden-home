...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recdi5MR9jS4xpwbP","name":"Excheqr","introduction":"All-in-one Platform to Manage Your Crypto Treasury","website":"https://www.excheqr.xyz/","twitter":"https://twitter.com/excheqr_xyz","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"receGQPE0CmvWXJgc","name":"Commercial Finance"}],"chains":[]};
