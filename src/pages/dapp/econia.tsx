...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recXA1ukffAhyLqVl","name":"Econia","introduction":"Econia is a back-end settlement layer developed on Aptos's Block-STM execution engine. It utilizes a Move-native codebase and leverages Aptos for composability and parallelism, offering a suite of extensible features to integrating protocols and market makers. Designed by developers, for developers, and incorporating developer feedback, Econia unlocks the foundational layer of Aptos DeFi, enhancing its functionality and versatility.","website":"https://econialabs.com","twitter":"https://twitter.com/EconiaLabs","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/econia-labs/econia","whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
