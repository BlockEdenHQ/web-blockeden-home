...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recU1VuO5ybmV4nj2","name":"Wave Wallet","introduction":"Waves is a wallet built with a security-first principles for the Sui blockchain. An enclave for your digital assets.","website":null,"twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recjlK9nrNPVACbL0","name":"Wallet"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
