...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recHr66uqf9QIxXB0","name":"Blockscope","introduction":"Blockscope is a Web3 data platform that enables anyone interested in on-chain data to quickly spin up live or historical data pipelines","website":"https://www.blockscope.co/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
