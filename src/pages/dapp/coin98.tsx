...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recLtQc2DDPEQfqkg","name":"Coin98","introduction":"Coin98 Wallet is a secure and user-friendly non-custodial cryptocurrency wallet that supports multiple blockchains, including Ethereum, Binance Smart Chain, and Solana.","website":null,"twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recjlK9nrNPVACbL0","name":"Wallet"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
