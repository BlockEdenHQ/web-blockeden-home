...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recx8CcFQmOes5i4j","name":"MovEX","introduction":"The first AMM+ order book DEX with hybrid liquidity on Sui, which combines the advantages of AMM and order book to provide everyone with a smooth trading experience by creating a hybrid liquidity pool.","website":"https://www.movex.exchange/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recjij7AtXPBhoL3j","name":"Dex"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
