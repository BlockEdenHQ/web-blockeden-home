...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recNsxBwiaYGhiFzR","name":"Filta","introduction":"Filta is the face filter NFT marketplace being built by veterans from Pixar/Oculus/Facebook. ","website":"http://www.getfilta.com/","twitter":"https://twitter.com/GetFilta","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
