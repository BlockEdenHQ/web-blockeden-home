...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recTdJzBBq8d4NOmx","name":"SlashAuth","introduction":"[Inactive] Slashauth builds a developer platform for web3 enabled apps. ","website":"https://www.slashauth.com/","twitter":"https://www.twitter.com/slashauth","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"recA9e08qAY2FbBIt","name":"DID"}],"chains":[]};
