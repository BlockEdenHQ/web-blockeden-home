...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rec3rjPDrAAMs5bz5","name":"DolarApp","introduction":"DolarApp allows LatAm inhabitants (starting with México) to dollarize their everyday finances.","website":"https://www.dolarapp.com/","twitter":"https://twitter.com/getdolarapp","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
