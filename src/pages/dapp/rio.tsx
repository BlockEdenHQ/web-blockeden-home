...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"reckDpbAGG2MQfekA","name":"Rio","introduction":"Rio lets users buy and sell crypto and stablecoins in 5 minutes or less, using local payment methods in LATAM.","website":"https://www.riotransfer.co/","twitter":"https://twitter.com/rio_transfer","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
