...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rec5kwk1TcxUCxm3E","name":"Poko","introduction":"Poko enables seamless transfers from local payment rails to web3 infrastructure enabling web3 wallets, marketplaces, games and DApps","website":"http://www.pokoapp.xyz/","twitter":"https://twitter.com/poko_app","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
