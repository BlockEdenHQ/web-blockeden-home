...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recgwbAsSL1hw3Q2k","name":"Notabene","introduction":"Notabene helps businesses perform crypto transactions in a regulatory compliant way.","website":"https://notabene.id/","twitter":"https://twitter.com/notabene_id","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/Notabene-id","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"receGQPE0CmvWXJgc","name":"Commercial Finance"}],"chains":[]};
