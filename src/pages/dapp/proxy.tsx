...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recgeIKunbAwwHxR7","name":"Proxy","introduction":"A mobile and wearable wallet that makes interacting with blockchain-based products and services seamless, fun, and empowering.","website":"https://proxy.com/","twitter":"https://twitter.com/proxy","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
