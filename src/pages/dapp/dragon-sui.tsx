...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rec6Tw1wWJdKdtTOM","name":"Dragon SUI","introduction":"An NFT market built on Sui and enables minting, collecting and trading NFTs.","website":"https://dragonsui.com/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recAaP55eAVmXWO7x","name":"NFT Markets"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
