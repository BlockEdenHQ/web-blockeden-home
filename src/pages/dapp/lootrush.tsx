...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recI03tbY0LoD5VrG","name":"LootRush","introduction":"We create an affordable way for gamers to start playing crypto games and a secure way for investors to earn yield through NFTs.","website":"https://www.lootrush.com/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"recurwxmBmR0NX6iU","name":"GameFi"}],"chains":[]};
