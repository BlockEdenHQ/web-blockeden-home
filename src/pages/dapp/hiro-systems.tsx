...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recgkbRUyCrypLFWk","name":"Hiro Systems","introduction":"Hiro System builds developer tools for Bitcoin L1 and the Stacks L2 (layer-2). ","website":"https://hiro.so/","twitter":"https://twitter.com/hirosystems","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/hirosystems","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
