...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recBjI0mvWH7uHb2x","name":"StarSpace","introduction":"An NFT market built on Sui waiting to be launched.","website":"https://www.starspace.io/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recAaP55eAVmXWO7x","name":"NFT Markets"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
