...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recx0flS7sQZIjJsA","name":"Multibase","introduction":"Powerful web3 analytics tools to help you convert, engage, and retain more users. Multibase makes it easy to analyze web3 users.","website":"https://www.multibase.co/","twitter":"https://twitter.com/multibase_co","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
