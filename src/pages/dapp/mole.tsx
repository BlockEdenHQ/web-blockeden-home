...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recENtoOSRxAW5IME","name":"Mole","introduction":"Mole is a DeFi protocol that offers a range of financial services including savings, leveraged yield farms, and funds. It's designed to cater to the diverse needs of DeFi users, providing opportunities for both savings and higher-risk, higher-reward yield farming, as well as fund management.","website":"https://mole.fi/","twitter":"https://twitter.com/moledefi","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/Mole-Fi","whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
