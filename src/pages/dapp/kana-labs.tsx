...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recXNuHX20BojRiVI","name":"Kana Labs","introduction":"Kana Labs is a cross-chain bridge aggregator that caters to all key DeFi needs across multiple networks. Users can swap, stake, farm, lend, borrow, and more in a single multi-chain.","website":"https://app.kanalabs.io/","twitter":"https://twitter.com/kanalabs","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
