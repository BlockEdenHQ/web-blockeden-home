...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"reclOiigK2ZJg69Dt","name":"TraceMove","introduction":"TraceMove is a blockchain explorer and analytics platform for Aptos. It enables users to search the version, transactions, addresses, tokens on Aptos.","website":"https://tracemove.io","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recDBsMXVvsaL4k93","name":"Explorer"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
