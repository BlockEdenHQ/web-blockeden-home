...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recek2VFUc8mGXBS0","name":"Flux","introduction":"We are building Flux- Flux is a Mobile App for merchants, freelancers, regular users(P2P) to make and accept payments from their customers anywhere in the world using crypto or fiat.","website":"https://iflux.app/","twitter":"https://twitter.com/ifluxdotapp","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"recdqn1Bhu1nOlW6y","name":"Consumer Finance"}],"chains":[]};
