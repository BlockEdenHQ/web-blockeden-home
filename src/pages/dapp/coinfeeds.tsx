...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recothoamcA2ZNXHd","name":"Coinfeeds","introduction":"Coinfeeds is an API that provides real-time news and social sentiment on any cryptocurrency. ","website":"https://coinfeeds.io/","twitter":"https://twitter.com/coinfeeds_ai","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
