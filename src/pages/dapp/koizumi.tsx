...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recBzUsSnxxIqC1fT","name":"Koizumi","introduction":"Koizumi is an NFT Aggregator Tool that showcases the best deals from the first multi-chain marketplaces. It provides users with the ability to quickly \"snipe\" or acquire NFT collections, making it an efficient tool for those looking to expand their NFT portfolios or seize profitable opportunities in the NFT market.","website":"https://koizumi.io","twitter":"https://twitter.com/KoizumiAPT","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/KoizumiAPT","whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
