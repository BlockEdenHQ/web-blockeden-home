...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rechifdfsaLh5XIaD","name":"Ethos","introduction":"Ethos Wallet is a non-custodial cryptocurrency wallet that provides users with a simple and secure platform to manage their digital assets. It allows users to store, send, receive, and exchange various cryptocurrencies, including Bitcoin, Ethereum, and Litecoin. Ethos Wallet is available for mobile devices and desktop computers.","website":null,"twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recjlK9nrNPVACbL0","name":"Wallet"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
