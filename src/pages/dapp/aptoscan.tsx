...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recuafElJtcJ7qvMe","name":"AptoScan","introduction":"AptoScan is a platform to explore Aptos blockchain transactions and chain analytics. Developer APIs and useful resources are available on AptoScan.","website":"https://aptoscan.com/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recDBsMXVvsaL4k93","name":"Explorer"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
