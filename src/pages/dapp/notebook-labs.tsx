...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"reczATldNio6QJxk7","name":"Notebook Labs","introduction":"Solve the Web3 identity problem by using Zero-Knowledge to provide both anonymous proof-of-humanity and credential aggregation.","website":"http://www.notebooklabs.xyz/","twitter":"https://twitter.com/NotebookLabs","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"reclEQU2qkwkTdH3d","name":"Zero-knowledge"}],"chains":[]};
