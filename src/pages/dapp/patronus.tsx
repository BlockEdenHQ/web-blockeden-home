...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recN1JEdZY4pX8fUz","name":"Patronus","introduction":"Patronus is a DeFi Liquidity Protocol which aims to provide a suite of DeFi products and services for a safer and more efficient capital flow.","website":"https://patronus.fi/","twitter":"https://twitter.com/Patronus_Fi","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/patronusfi","whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
