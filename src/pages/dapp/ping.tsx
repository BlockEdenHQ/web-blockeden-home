...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recXIXHGDdPy66Lwq","name":"Ping","introduction":"Ping enables international contractors and freelancers to have access to a personal Dollar account in the US","website":"https://www.letsping.com/","twitter":"https://twitter.com/holapinglatam","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"recdqn1Bhu1nOlW6y","name":"Consumer Finance"}],"chains":[]};
