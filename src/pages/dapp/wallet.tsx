...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"recjlK9nrNPVACbL0","name":"Wallet","description":"A blockchain wallet is a digital wallet allowing users to manage, store, and transfer cryptocurrencies securely while interacting with blockchain."};
  const tag = title;
