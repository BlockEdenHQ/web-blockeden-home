...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recXFwTn4SJgpykhH","name":"EthosX","introduction":"A decentralized finance platform creating end-to-end financial derivatives on blockchains.","website":"https://www.ethosx.finance/","twitter":"https://twitter.com/ethosx_finance","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"recjij7AtXPBhoL3j","name":"Dex"}],"chains":[]};
