...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"recWLjiMK106T8B9O","name":"Lending","description":"Lending is the act of providing funds temporarily with an expectation of repayment, often with interest."};
  const tag = title;
