...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recQueRUPYQMVHee5","name":"Jasmine Energy","introduction":"Jasmine makes the buying and selling of renewable energy assets easy, accessible, and transparent.","website":"http://www.jasmine.energy/","twitter":"https://www.twitter.com/jasmine_energy","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/Jasmine-Energy","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
