...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recr6df0qWQ0NnOR3","name":"Mudrex","introduction":"Mudrex is on a mission to bring risk optimised high yield investments to everyone.","website":"https://mudrex.com/","twitter":"https://twitter.com/officialmudrex","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/mudrex","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
