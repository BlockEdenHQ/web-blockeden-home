...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recUqHRK4AXZWoH4O","name":"Soon","introduction":"By investing on a schedule and selling available gains when you spend, Soon automates investing from beginning to end. ","website":"https://soon.app/","twitter":"https://twitter.com/soonfinance","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
