...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recRhuJBHKfpdsCQW","name":"Bitstack","introduction":"Empower people to participate in a more open financial system It starts with helping people save & invest in Bitcoin, effortlessly.","website":"https://www.bitstack-app.com/","twitter":"https://twitter.com/bitstack_","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
