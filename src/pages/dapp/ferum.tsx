...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recWvL2Mlkb0U7YuD","name":"Ferum","introduction":"Ferum is an on-chain order book on Aptos that stands out for its developer-friendly features. It provides a platform that is easy to navigate and use, making it an ideal choice for developers working with Aptos.","website":"https://www.ferum.xyz/","twitter":"https://twitter.com/ferumxyz","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/ferum-dex/","whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
