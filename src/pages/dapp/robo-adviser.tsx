...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"rec57HyMeH62koASo","name":"Robo-adviser","description":"Robo-adviser is a digital platform that provides automated financial advice based on algorithms."};
  const tag = title;
