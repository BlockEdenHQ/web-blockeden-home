...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recNDGg7hLzcgVC6r","name":"PLASMAVERSE","introduction":"A metaverse ARPG game running on Aptos/Sui blockchains.","website":"https://www.plasmaverse.xyz/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recurwxmBmR0NX6iU","name":"GameFi"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
