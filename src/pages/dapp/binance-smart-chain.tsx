...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"recafdsESaixl7aJJ","name":"Binance Smart Chain","description":"Binance Smart Chain (BSC) is a blockchain network built for running smart contract-based applications. It operates parallel to Binance Chain, offering high-speed, low-fee transactions, and is compatible with the Ethereum Virtual Machine (EVM)."};
  const tag = title;
