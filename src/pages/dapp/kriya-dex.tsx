...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rechaIdhMnrQ8RQTx","name":"Kriya DEX","introduction":"A derivative DEX built on Sui and allows a leverage multiplier of up to 20.","website":"https://efficacy.finance/kriya-sui-dex/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recjij7AtXPBhoL3j","name":"Dex"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
