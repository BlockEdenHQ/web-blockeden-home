...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recALS3ffv9icKNR4","name":"Jujube Finance","introduction":"A Dex&NFTs platform on the Aptos / Sui. Community-driven, trade safely, fast and user-friendly AMM protocol.","website":"https://www.jujube.finance","twitter":"https://twitter.com/JujubeFinance","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/jujubefinance","whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
