...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recJ5nh3AreC6RCVH","name":"Seam Money","introduction":"Seam pools are multi-protocol composite positions for staking, liquidity pools, lending, on-chain order-books, and other derivatives.","website":"https://seam.money/","twitter":"https://twitter.com/SeamMoney","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/seammoney/","whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
