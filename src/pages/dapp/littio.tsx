...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recYHwftOKZLAEJjx","name":"Littio","introduction":"Littio is a neobank focused on solving the currency devaluation problem for Latin Americans.","website":"https://www.littio.co/","twitter":"https://mobile.twitter.com/littioco","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
