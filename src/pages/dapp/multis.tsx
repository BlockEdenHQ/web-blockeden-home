...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recuiGLvMddVl6YPw","name":"Multis","introduction":"We build accounting & treasury management software solutions for web3 organizations.","website":"https://multis.com/","twitter":"https://twitter.com/multisHQ","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/multis","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"receGQPE0CmvWXJgc","name":"Commercial Finance"}],"chains":[]};
