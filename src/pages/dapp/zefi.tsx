...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recHRWl9kkEJ3CNUr","name":"ZeFi","introduction":"ZeFi is a zk native cloud platform that lets developers build and deploy zero knowledge circuits directly on the cloud.","website":"https://zefi.io/","twitter":"https://twitter.com/zefiHQ","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"reclEQU2qkwkTdH3d","name":"Zero-knowledge"}],"chains":[]};
