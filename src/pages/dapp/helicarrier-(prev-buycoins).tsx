...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rec5mkxxftbMkslMJ","name":"Helicarrier (prev Buycoins)","introduction":"Helicarrier (previously Buycoins) is building cryptocurrency infrastructure for Africa.","website":"https://helicarrier.studio/","twitter":"https://twitter.com/buycoins_africa","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
