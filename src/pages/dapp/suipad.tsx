...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rechKAzZ2YksHEG1n","name":"SuiPad","introduction":"The first-ever Launchpad built on Sui and it includes functions like IDO, ISO and INO, etc.","website":"https://suipad.xyz/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
