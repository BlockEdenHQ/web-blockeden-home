...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator","description":"Y Combinator is a renowned startup accelerator fostering entrepreneurial success."};
  const tag = title;
