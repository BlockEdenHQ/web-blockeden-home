...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recDtQtg55jotYWvV","name":"Pontem Network","introduction":"Pontem is a product development studio committed to promoting global financial inclusion through blockchain technology. In partnership with Aptos, they are building foundational decentralized applications (dApps) and other infrastructure to facilitate the adoption of Aptos's Layer 1. This includes development tooling, Ethereum Virtual Machines (EVMs), Automated Market Makers (AMMs), and more. ","website":"https://pontem.network/","twitter":"https://twitter.com/PontemNetwork","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/pontem-network","whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
