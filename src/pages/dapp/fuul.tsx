...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recRPJ2VXCiEiMGur","name":"Fuul","introduction":"fuul xyz is an affiliate marketing protocol that lets web3 projects partner with content creators in a trustless way. Fuul streamlines partnership discovery, attribution and payouts on-chain","website":"https://www.fuul.xyz/","twitter":"https://twitter.com/fuul_xyz","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rech8ZZffiG9zOQga","name":"a16z crypto startup school"}],"chains":[]};
