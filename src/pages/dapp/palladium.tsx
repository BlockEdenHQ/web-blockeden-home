...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recREiahJH0dPKIa2","name":"Palladium","introduction":"An AMM cross-chain DEX and is yet to be launched.","website":"https://twitter.com/Palladium_DEX","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recjij7AtXPBhoL3j","name":"Dex"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
