...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recINQoxv4kLCthFy","name":"TRM Labs","introduction":"A blockchain intelligence company that helps financial institutions, crypto businesses and government agencies detect and investigate crypto-related financial crime and fraud.","website":"https://trmlabs.com/","twitter":"https://twitter.com/trmlabs","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/trmlabs","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
