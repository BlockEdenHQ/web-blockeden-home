...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recIlfOGDRB9cZi5e","name":"Sui Punks","introduction":"The first NFT collectible in the Sui NFT ecosystem and is a pixelated NFT project.","website":"https://suipunks.xyz/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"reccOPMXhhegGDuTP","name":"NFT Collection"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
