...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recjVUvdWMtDsLO8h","name":"Coinbase","introduction":" A digital currency wallet and platform where merchants and consumers can transact with new digital currencies like bitcoin, ethereum, and litecoin.","website":"https://www.coinbase.com/","twitter":"https://twitter.com/coinbase","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
