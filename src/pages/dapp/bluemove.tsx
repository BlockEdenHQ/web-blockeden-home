...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recZsMQSiIGYzwDxH","name":"BlueMove","introduction":"The first-ever NFT market for communities built on Aptos and Sui that proactively rewards investors, collectors and artists.","website":"https://sui.bluemove.net/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recAaP55eAVmXWO7x","name":"NFT Markets"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
