...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recOu2tNzfQ2e9jaT","name":"Questbook","introduction":"Tools for the future of pseudonymous, permissionless work. It provides an efficient tool for creating and managing grants from your protocol, completely on chain..","website":"https://questbook.xyz/","twitter":"https://twitter.com/questbookapp","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/questbook","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"reccVhTgz8mENzv9N","name":"DAO"}],"chains":[]};
