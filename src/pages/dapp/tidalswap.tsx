...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rec6xWh742hWDcNs8","name":"Tidalswap","introduction":"An advanced cross-chain AMM protocol built on Aptos and Sui.","website":"https://tidalswap.com/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recjij7AtXPBhoL3j","name":"Dex"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
