...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recCqhQhJQnQMb6CU","name":"HoustonSwap","introduction":"HoustonSwap is the first concentrated liquidity market maker on Aptos and Sui designed to automate the whole operation. The goal of this protocol is to make better use of capital, minimize impermanent losses for liquidity providers, and give traders the best trading price. We also know that the concentrated liquidity mechanism is not friendly for project owners, so we offer a few unique features to help the ecosystem.","website":"https://houstonswap.io/","twitter":"https://twitter.com/Houston_swap","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
