...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"recdqn1Bhu1nOlW6y","name":"Consumer Finance","description":"Consumer Finance is the sector dedicated to personal financial products and services."};
  const tag = title;
