...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"reccYovTfJlTlKOxQ","name":"Axelar","introduction":"Axelar delivers secure cross-chain communication for Web3. Our infrastructure enables dApp users to interact with any asset or application, on any chain, with one click.","website":"https://axelar.network/","twitter":"https://twitter.com/axelarcore","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/axelarnetwork","whitepaperUrl":null,"tags":[{"id":"recHw8cINcIMu9B07","name":"Cross-chain Bridge"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
