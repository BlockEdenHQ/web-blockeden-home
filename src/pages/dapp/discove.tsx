...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recqCXKRQHYgtAJOz","name":"Discove","introduction":"A protocol for composable mini-apps, starting with decentralized social and a client for Farcaster.","website":"https://www.discove.app/","twitter":"https://twitter.com/discovexyz","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rech8ZZffiG9zOQga","name":"a16z crypto startup school"}],"chains":[]};
