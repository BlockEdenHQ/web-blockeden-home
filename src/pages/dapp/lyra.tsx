...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rec40V09AKHMWLJWu","name":"Lyra","introduction":"A crypto-native virtual card provider that allows users to easily create cards and fund them with cryptocurrency.","website":"https://paywithlyra.com/","twitter":"https://twitter.com/lyrapay_","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"},{"id":"recdqn1Bhu1nOlW6y","name":"Consumer Finance"}],"chains":[]};
