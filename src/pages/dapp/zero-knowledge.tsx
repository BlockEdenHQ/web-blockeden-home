...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"reclEQU2qkwkTdH3d","name":"Zero-knowledge","description":"Zero-knowledge is a cryptographic method ensuring data privacy without revealing underlying information."};
  const tag = title;
