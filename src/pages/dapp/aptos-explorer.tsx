...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recwBbu0qgL6r6cce","name":"Aptos Explorer","introduction":"Aptos Labs Explorer allows you to explore transactions, accounts, events, nodes, gas fees and other network activity within the Aptos Network.","website":"https://explorer.aptoslabs.com/","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/aptos-labs/explorer","whitepaperUrl":null,"tags":[{"id":"recDBsMXVvsaL4k93","name":"Explorer"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
