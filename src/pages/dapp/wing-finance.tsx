...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recUqqfHbQZC3WiC2","name":"Wing Finance","introduction":"Wing Finance is a credit-based, cross-chain DeFi platform. The content from this URL could not be retrieved, so I'm unable to provide a detailed introduction.","website":"https://flash.wing.finance/aptos","twitter":"https://twitter.com/Wing_Finance","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
