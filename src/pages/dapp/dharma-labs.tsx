...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recGnu0ZsyBdUbRcT","name":"Dharma Labs","introduction":"[Acquired] Dharma is the only Ethereum wallet capable of seamlessly moving money between any US bank account and decentralized exchanges like Uniswap.","website":"https://dharma.io/","twitter":"https://twitter.com/Dharma_HQ","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
