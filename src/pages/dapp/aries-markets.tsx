...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recbMQAJJptW3GvZN","name":"Aries Markets","introduction":"Aries Markets is a decentralized exchange on Move, aiming to simplify DeFi user experience. It offers a unified margin account for earning interest, borrowing against collateral, leveraged swaps, and margin trading via an on-chain order book. It also provides easy access to other Aptos DeFi products.","website":"https://ariesmarkets.xyz/","twitter":"https://twitter.com/AriesMarkets","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
