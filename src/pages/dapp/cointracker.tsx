...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"reciS0MbIfHTsvn00","name":"CoinTracker","introduction":" A portfolio assistant for cryptocurrency used by over 1 million cryptocurrency holders with over $50 Billion in crypto assets on exchanges.","website":"https://www.cointracker.io/","twitter":"https://twitter.com/CoinTracker","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/coin-tracker","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
