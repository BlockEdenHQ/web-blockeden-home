...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"recLUPl9cA6js34h3","name":"Arbitrum","description":"Arbitrum is a Layer 2 scaling solution for Ethereum that improves scalability via Arbitrum Rollups. It increases transaction throughput and decreases costs while maintaining strong security and Ethereum compatibility."};
  const tag = title;
