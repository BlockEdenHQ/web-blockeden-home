...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recg5iu4963iTMxrz","name":"Cedalio","introduction":"A blockchain empowered alternative to Firebase. Cedalio starts with a Decentralized Storage GraphQL Gateway, you can use Cedalio as a decentralized database for applications that speak GraphQL.","website":"https://cedalio.com/","twitter":"https://twitter.com/CedalioTech","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/cedalio/","whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
