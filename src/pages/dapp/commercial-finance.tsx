...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"receGQPE0CmvWXJgc","name":"Commercial Finance","description":"Commercial Finance is the provision of loans and financial solutions to businesses."};
  const tag = title;
