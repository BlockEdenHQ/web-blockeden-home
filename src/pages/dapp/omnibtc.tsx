...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recXlb0MfQjsLIv20","name":"OmniBTC","introduction":"A decentralized omnichain financial platform built by the ChainX team based on the LayerZero protocol. OmniBTC proposed a new pathway for OmniLending.","website":"https://app.omnibtc.finance/swap","twitter":null,"marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recsjTJv52vVYdOqg","name":"Sui"}]};
