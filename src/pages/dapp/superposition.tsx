...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"rec0o5pFWpDx0HX5o","name":"Superposition","introduction":"Superposition is a next-generation omnichain lending protocol. It is powered by the Concordia protocol, a universal cross-chain credit reservoir shared across blue-chip DeFi applications. Superposition's high-efficiency architecture results in superior credit pool utilization, unlocking cheap cost of capital for borrowers.","website":"https://www.superposition.finance/","twitter":"https://twitter.com/SuperpositionFi","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rec9txQaAdTdKG8aS","name":"Defi"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
