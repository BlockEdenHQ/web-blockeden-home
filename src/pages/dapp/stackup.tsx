...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recvaPUsmL6EFD7v4","name":"Stackup","introduction":"Stackup is a suite of open-source developer tools for building user-friendly blockchain products. It starts with ERC-4337 infrastructure.","website":"https://www.stackup.sh/","twitter":"https://twitter.com/stackup_fi","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"recOb6SjNtgrJ8uvy","name":"Y Combinator"}],"chains":[]};
