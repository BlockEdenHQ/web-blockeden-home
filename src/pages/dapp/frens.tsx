...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recjgycYJuNjcfVff","name":"frens","introduction":"WeChat for web3. Message and transact with friends, protocols, and smart contracts. Pay, vote, trade, and crowdfund without leaving the conversation.  Web3 experiences are inherently multiplayer, but there’s no way to message friends and groups with the context of on-chain actions. We’re building the communications super app that seamlessly integrates transactions, applications, and protocols into the messaging experience.","website":"https://www.frens.lol/","twitter":"https://twitter.com/frenslol","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":null,"whitepaperUrl":null,"tags":[{"id":"rech8ZZffiG9zOQga","name":"a16z crypto startup school"}],"chains":[]};
