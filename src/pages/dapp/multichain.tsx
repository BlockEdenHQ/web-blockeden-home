...
const DappTemplate: React.FC = () => {
  const project: Project = {"id":"recnty7qMNt1S0h5j","name":"Multichain","introduction":"Multichain is a non-custodial cross-chain router protocol symbolizing decentralization. It processes Multichain cross-chain bridging and smart contract methods on other chains. Multichain’s 1:1 bridge enables users to perform 0 slippage transfers and eliminate the hidden cost associated with AMM. Multichain Router allows users to swap between any two chains freely, reducing fees and making it easier to move between chains.","website":"https://multichain.org/","twitter":"https://twitter.com/MultichainOrg","marketCap":null,"tokenSymbol":null,"logoUrl":null,"explorerUrl":null,"mediumUrl":null,"redditUrl":null,"githubUrl":"https://github.com/anyswap","whitepaperUrl":null,"tags":[{"id":"recHw8cINcIMu9B07","name":"Cross-chain Bridge"}],"chains":[{"id":"recDpAX5fIjzGzjgS","name":"Aptos"}]};
