...
export default function DappListTemplate() {
  const {name: title, description: intro} = {"id":"recxaaAgGx0u9YlEA","name":"NFT Checkout","description":"NFT Checkout is the integration of unique digital assets into online purchasing systems."};
  const tag = title;
