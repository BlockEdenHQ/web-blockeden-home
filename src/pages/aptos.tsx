              ...
              <div className="col-xl-8 col-lg-9 col-md-10">
                ...
                <div className="d-flex flex-column flex-sm-row justify-content-center align-items-center align-items-sm-start mt-5">
                  <div className="d-flex flex-column mx-1 text-center">
                    ...
                    <Link
                      href="/docs/aptos/"
                      className="text-small hover-arrow"
                    >
                      View Documentation
                    </Link>
                  </div>
                ...
                <ul className="d-flex flex-wrap justify-content-center list-unstyled">
                  ...
                  >
                    <img
                      style={{ width: "140px" }}
                      className="icon-md "
                      src="https://tp-misc.b-cdn.net/blockeden/secure3.svg"
                      alt="icon"
                    />
                  </li>
                  <li
                  ...
                  >
                    <img
                      style={{ width: "140px" }}
                      className="icon-md"
                      src="https://tp-misc.b-cdn.net/blockeden/aptos-logo.svg"
                      alt="icon"
                    />
                  </li>
                  ...
                  >
                    <img
                      style={{ width: "160px" }}
                      className=" icon-md "
                      src="https://tp-misc.b-cdn.net/blockeden/aptos-eden-hei-heng.png"
                      alt="icon"
                    />
                  </li>
                  <li
                  ...
                  >
                    <img
                      style={{ width: "160px" }}
                      className=" icon-md"
                      src="https://tp-misc.b-cdn.net/blockeden/aptos-global-1.png"
                      alt="icon"
                    />
                  </li>
                </ul>
                ...
                <div className="row">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="lead pr-xl-4">
                        Inspect data, write SQL, and build data visualization
                        dashboards with our web portal.
                      </p>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="lead pr-xl-4">
                        99.9% SLA uptime API over HTTPs, hosted on AWS's quality
                        servers.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    <div className="icon-round bg-primary mr-3">
                      <img
                        className="icon bg-primary"
                        src="/assets/img/icons/theme/weather/cloudy-night.svg"
                        alt="icon"
                        data-inject-svg
                      />
                    </div>
        ...
        <section className="bg-primary-alt has-divider">
          <div className="container pb-0">
            <div className="row justify-content-center text-center mb-6">
              <div className="col-xl-8 col-lg-9">
                <h2 className="display-4 mx-xl-6">
                  Serve Aptos developers since mainnet day-one
                </h2>
                <p className="lead">
                  We are a fully-committed team striving to bringing web3 to
                  everyone on the planet, together with powerful developers and
                  businesses.
                </p>
              </div>
            </div>
            <div className="row justify-content-center text-center">
              <div
                className="col-md-4 mb-3 mb-4 mb-md-0"
                data-aos="fade-up"
                data-aos-delay={100}
              >
                <CountUp
            ...
            <div className="row justify-content-center mt-6 mb-lg-n7">
              <div className="col-xl-8 col-lg-9 layer-1">
                <div className="video-poster shadow-lg rounded mb-3">
                  ...
                  >
                    <img
                      src="https://tp-misc.b-cdn.net/blockeden/BlockEden-xyz-analytics-share-dashboard.png"
                      alt="Image"
                    />
                  </a>
                </div>
          ...
          <div className="container pb-md-6">
            ...
            <div className="row">
              ...
              >
                <img
                  className="icon"
                  src="/assets/img/icons/theme/shopping/wallet.svg"
                  alt="icon"
                  data-inject-svg
                />
                <div className="ml-3">
                  <h5>What is Aptos?</h5>
                  <p>
                    Aptos is a layer one proof-of-stake blockchain that uses key
                    elements of Diem, the former Meta blockchain, and Move, a
                    programming language developed by Meta using the Rust
                    language.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="ml-3">
                  <h5>What is Move?</h5>
                  <p>
                    Move is a smart contract language built by engineers at Meta
                    and intended to be more secure and efficient than Solidity.
                    Those engineers left Meta and built their own blockchain
                    businesses - Aptos Labs and Mysten Labs.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <img
                  className="icon"
                  src="/assets/img/icons/theme/files/cloud-upload.svg"
                  alt="icon"
                  data-inject-svg
                />
                <div className="ml-3">
                  ...
                  <p>
                    There are hundreds of projects built on Aptos ecosystem, and
                    the number is still growing. The blockchain could undertake
                    100,000 transactions per second. Thus, there is still great
              ...
              <div className="col">
                <div className="card1 card-body border-0 o-hidden mb-0 shadow-3d text-light bg-primary">
                  <div className="position-relative d-flex flex-column flex-md-row justify-content-between align-items-center">
                    <h3 className={clsx("h3 text-center mb-md-0", styles.h3)}>
