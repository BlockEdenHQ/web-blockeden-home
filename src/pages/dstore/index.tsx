        ...
        <div className="container pt-3 pb-0">
          <div className="row justify-content-center text-center mb-6">
            <div className="col-xl-8 col-lg-9">
              ...
              <p className="lead">
                Login to our dashboard and drag and drop your files from your
                local to the distributed storage network. It’s easy like that -
                No need for private key or signatures.
              </p>
            </div>
          </div>
          <div className="row">
            <div className="col-lg-3 col-md-4 mb-4 mb-md-0">
              <ul className="nav flex-column" role="tablist">
                <li className="nav-item">
                  <a
                    className="nav-link btn btn-light p-2 text-left active"
                    href="#app-tab-1"
                    data-toggle="tab"
                ...
                <li className="nav-item">
                  <a
                    className="nav-link btn btn-light p-2 text-left"
                    href="#app-tab-2"
                    data-toggle="tab"
