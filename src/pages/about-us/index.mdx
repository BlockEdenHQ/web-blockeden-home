...
* **Ecosystem contribution** for protocol builders
...
<div className={"row"}>
  <div className={"col-4"}><h2>Funding status</h2></div>
  <div className={"col-8"}>
    We are self-funded for now, post-release, acquiring customers, increasing revenues, and building connections with investors and business partners.
  </div>
</div>
...
<div className={"row"}>
  <div className={"col-4"}><h2>Tokenomics</h2></div>
  <div className={"col-8"}>
...
<div className={"row"}>
  <div className={"col-4"}><h2>Our backers</h2></div>
  <div className={"col-8"}>
<section className="pt-0 pb-0 mt-1">
  <div className="container ">
    <div className="row ">
...
<div className={"row"}>
  <div className={"col-4"}><h2>Our location</h2></div>
  <div className={"col-8"}>
...
<div className={"row"}>
  <div className={"col-4"}><h2>Contact our BD</h2></div>
  <div className={"col-8"}>
...
<div className={"row"}>
  <div className={"col-4"}><h2>Build with us</h2></div>
  <div className={"col-8"}>
  If your mission is to build the killer app 🚀 to bring web3 to everyone in our galaxy, then our mission is to be your best ally. Together, we fight for next-generation decentralization innovations.
    <a href={"https://discord.gg/4Yfvs2HWey"}> Join our Discord community to stay in touch.</a>
  </div>
</div>

<section><div><div ><div ><div class="card1 card-body border-0 o-hidden m-0 shadow-3d text-light bg-primary"><div class="position-relative d-flex flex-column flex-md-row justify-content-between align-items-center"><h3 class="h3  mb-md-0" style={{fontSize: "28px"}}>BlockEden.xyz media packages</h3><a href="/brand-assets" class="btn btn-lg btn-white">Get brand assets</a></div><div class="decoration layer-0"><svg xmlns="http://www.w3.org/2000/svg" width="338" height="277" viewBox="0 0 338 277" fill="none" data-inject-url="https://blockeden.xyz/assets/img/decorations/deco-blob-1.svg" class="bg-primary-2" data-inject-svg="true">
