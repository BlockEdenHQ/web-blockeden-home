...
<div className={"row"}>
  ...
  <div className={"col-8"}>
  If your mission is to build the killer app 🚀 to bring web3 to everyone in our galaxy, then our mission is to be your best ally. Together, we fight for the next-generation decentralization innovations.
