...
<section className="pt-0 pb-0 mt-5">
...
<section><div><div ><div ><div class="card1 card-body border-0 o-hidden m-0 shadow-3d text-light bg-primary"><div class="position-relative d-flex flex-column flex-md-row justify-content-between align-items-center"><h3 class="h3 text-center mb-md-0" style={{fontSize: "28px"}}>BlockEden.xyz media packages</h3><a href="/brand-assets" class="btn btn-lg btn-white">Get brand assets</a></div><div class="decoration layer-0"><svg xmlns="http://www.w3.org/2000/svg" width="338" height="277" viewBox="0 0 338 277" fill="none" data-inject-url="https://blockeden.xyz/assets/img/decorations/deco-blob-1.svg" class="bg-primary-2" data-inject-svg="true">
